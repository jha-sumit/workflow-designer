...
export const EnhancedTable: React.FunctionComponent<EnhancedTableProps> = (props: EnhancedTableProps) => {
    const classes = useStyles();
    const [order, setOrder] = React.useState<Order>('asc');
    const [orderBy, setOrderBy] = React.useState<keyof Workflow>('lastRunAt');
