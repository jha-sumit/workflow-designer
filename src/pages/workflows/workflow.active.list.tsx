...
interface ActiveWorkflowsState {

}
class ActiveWorkflowsComponent extends Component<ActiveWorkflowsProps, ActiveWorkflowsState> {
    render() {
            ...
            <Table aria-label="collapsible table">
                <TableHead>
                    <TableRow>
                        ...
                        <TableCell>Instances in Error</TableCell>
